...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-[#08090A] border-b border-border">
      {/* Supported by Google for Startups Badge Banner */}
      <div className="w-full bg-[#050607]/80 backdrop-blur-md border-b border-border h-8 flex items-center justify-center">
        <a
          href="https://cloud.google.com/startup"
          target="_blank"
          rel="noopener noreferrer"
          className="group inline-flex items-center justify-center gap-1.5 text-[11px] sm:text-xs text-subtle/80 hover:text-white transition-colors duration-200"
        >
          ...
          <span className="text-[10px] text-purple/80 group-hover:text-purple group-hover:translate-x-0.5 transition-all duration-200">
            ↗
          </span>
        </a>
      </div>
      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {mobileMenuOpen && (
          <div className="fixed inset-0 top-24 bg-[#08090A] md:hidden z-40">
